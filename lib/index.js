...
const META_THOUGHT_RE = /(?:我|咱们|我们)(?:需要|打算|想|要|得|应该|先|正在|看下|看看|检查|确认|验证|测试|搜|找|读|写|查|思考|分析|认为|觉得|考虑|用了?|选(择|了|取|用)|准备|接下来|下面|来|尝试|开始|继续|用|使用|改|改用|改成|设计|重写|重做|修改|调整|更新|补充)/;

// v0.4.4: 过程性动作（"让我/我们来/我来"等）—— 不是已完成的事实
const PROCESS_ACTION_RE = /^(让我|我们来|我来|咱们|我们先|我们再|接下来|然后|于是|因此|所以)[^。！？!?]{0,30}/;

// v0.4.4: 不完整句子（以冒号/问号结尾，或含未配对的括号）
...
export function* streamMemories(memories, batchSize = 5) {
