...
export async function apply(ctx, config = {}) {
  ...
  ctx.effect(() => ctx.systemPrompt.section({
    ...
    text: `
## Memory System
You have access to a memory system that can store and retrieve important information across sessions.

### When to use memory_add:
- Save important decisions, principles, or lessons learned
- Remember user preferences, project details, or technical findings
- Store solutions to problems you solved
- Keep track of ongoing tasks or goals
- Record architecture decisions or design patterns

### When NOT to save:
- Routine conversational filler
- Already-known information
- Temporary context that expires quickly

### Memory layers:
- Layer 1 (Raw): Verbatim conversation snippets (rarely injected)
- Layer 2 (Key): Important facts and findings
- Layer 3 (Organized): Structured summaries and explanations
- Layer 4 (Deep): Core principles, decisions, and patterns (always injected)

### How to use:
Call the memory_add tool when something important is discussed. Include relevant tags if applicable.
`.trim(),
