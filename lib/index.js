...
export function assessLifecycle(m, lastAccessedAt) {
  ...
  if (daysSinceAccessed > 180) return MEM_LIFECYCLE.ARCHIVED;
  if (daysSinceAccessed > 90) return MEM_LIFECYCLE.STALE;
  if (daysSinceCreated < 7) return MEM_LIFECYCLE.NEW;
  return MEM_LIFECYCLE.ACTIVE;
}
